...
EXAMPLE_PARAMETERS = {
                       'geometry':{'n':40000,'i':50,'r':0.04,'d':5,'s':0.25,'e':0.05,'p':6},
                       'motion':{'t':24,'k':3.0,'w':1.0,'c':0.5},
                       'health':{'vi':1.0,'is':1.0,'ip':0.5/14,'sp':1.0,'ir':0.995/14,'id':0.005/14,'sr':0.98/14,'sd':0.02/14,'pd':0.02/14,'pr':0.96/14}
                      }
